            ...
            <li class="dropdown">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="managecomponent.php">Manage Components</a></li>
                  <li><a class="nav-link" href="managegrade.php">Manage Grade</a></li>
                  <li><a class="nav-link" href="managecompositions.php">Manage Compositions</a></li>
                  <li><a class="nav-link" href="createcode.php">Create unique Code</a></li>
